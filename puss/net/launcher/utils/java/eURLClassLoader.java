...
public class eURLClassLoader extends URLClassLoader implements Closeable {
            ...
            URLStreamHandlerFactory factory)
    {
        ...
        ucp = new eURLClassPath(urls, factory);
    ...
    public static eURLClassLoader newInstance(final URL[] urls, final ClassLoader parent)
    {
        ...
        eURLClassLoader ucl = AccessController.doPrivileged(
                new PrivilegedAction<eURLClassLoader>() {
    ...
    static
    {
        eSharedSecrets.seteJavaNetAccess(
                new eJavaNetAccess() {
