...
public class LoginTheme {
   ...
   public static ButtonStyle toAuth = new ButtonStyle(262, 307, 150, 47, "font", "button", 16.0F, Color.decode("0xd4dc7b"), true, Align.CENTER);
   public static ButtonStyle toLogout = new ButtonStyle(96, 367, 150, 47, "font", "button", 16.0F, Color.decode("0xd4dc7b"), true, Align.CENTER);
   public static ButtonStyle toGame = new ButtonStyle(262, 307, 150, 47, "font", "button", 16.0F, Color.decode("0xd4dc7b"), true, Align.CENTER);
   public static ButtonStyle toPersonal = new ButtonStyle(262, 367, 150, 47, "font", "button", 16.0F, Color.decode("0xd4dc7b"), true, Align.CENTER);
   public static ButtonStyle toOptions = new ButtonStyle(96, 307, 150, 47, "font", "button", 16.0F, Color.decode("0xd4dc7b"), true, Align.CENTER);
   public static ButtonStyle toRegister = new ButtonStyle(96, 367, 150, 47, "font", "button", 16.0F, Color.decode("0xd4dc7b"), true, Align.CENTER);
   ...
   public static ComboboxStyle servers = new ComboboxStyle(128, 431, 250, 25, "font", "combobox", 14.0F, Color.decode("0xA67A53"), true, Align.CENTER);
   public static ServerbarStyle serverbar = new ServerbarStyle(155, 490, 260, 16, "font", 15.0F, Color.decode("0xA67A53"), true);
   public static float fontbasesize = 14.0F;
